<x-app-layout>
    ...
    <div class="py-12">
        <div class="flex flex-wrap gap-3 items-center justify-center">
            <a href="#" class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 w-1/4">
